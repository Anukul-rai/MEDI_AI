        ...
        <div className="container mb-52 md:mb-0">
            ...
            <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <p className="text-sm italic text-gray-700">Kathmandu, Nepal</p>
                    </div>
                </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <p className="text-sm italic text-gray-700">+977 987654321</p>
                    </div>
                </div>
                ...
                <div className="mb-8 flex w-full max-w-[370px]">
                    ...
                    <p className="text-sm italic text-gray-700">drexample@gmail.com</p>
                    </div>
                </div>
                </div>
            </div>
