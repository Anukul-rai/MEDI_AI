            ...
            <div className="flex h-full justify-between flex-col md:flex-row">
                ...
                <ul className="flex flex-col  items-start gap-8 font-nunito text-sm">
                    ...
                    <p className="md:text-lg font-medium leading-6 text-gray-600 ">
                        What is the Disease Predictor, and how does it work?
                    </p>
                    <p className="mt-2">
                        <p className="md:text-base leading-6 text-gray-500">
                        The AI Disease PRedictor uses advanced AI to personalize
                    ...
                    <p className="mt-2">
                        ...
                        within the various Disease Predictor module, implementing stringent
                ...
                <ul className="flex flex-col  items-start gap-8 font-nunito text-sm ">
                    <li className="">
                    <p className="md:text-lg font-medium leading-6 text-gray-600">
                        How can I get started with the Disease Predictor?
                    </p>
                    <p className="mt-2">
                        <p className="md:text-base leading-6 text-gray-500">
