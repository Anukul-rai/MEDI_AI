...
function About() {
    return (
        ...
        >
            ...
            with features like doctor recommendations and AI chat assistance, helping individuals make well-informed decisions about their health.Our mission is to empower
